  ...
  return (
    <div className={styles.homeContainer}>
      ...
      <p className={styles.description}>
        This is a Website Security Research Project (WSRP) simulation built with React for educational purposes.
      </p>
      <h1>Instructions</h1>
      <p className={styles.description}>There is no instructions yet because there is no working code as of now but as the project continues there will be more added this part of the
        application.
      </p>
