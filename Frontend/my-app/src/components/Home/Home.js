...
these vulnerabilities and how to harden web apps to protect against them.
      ...
      <h2>Instructions</h2>
      <p className={styles.description}>
        Please begin by navigating to the security vulnerability you would like to learn more about using the menu to the left.
